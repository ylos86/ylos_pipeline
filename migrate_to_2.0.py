#!/usr/bin/env python3
"""
migrate_to_2.0.py - migre un projet Black Kite du schema legacy (sans schema_version) vers
...
def _cli(argv=None):
    p = argparse.ArgumentParser(description="Migration projet Black Kite legacy -> 2.0.")
