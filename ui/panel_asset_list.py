# -*- coding: utf-8 -*-
# Ylos Pipeline - ui/panel_asset_list.py
# Option A: persistent asset list panel showing all project assets
...
class YLOS_PT_AssetListPanel(bpy.types.Panel):
    ...
    bl_region_type = "UI"
    bl_category = "Ylos"
    bl_order = 1     # between Project (0) and Asset Context (2)
    ...
    def draw(self, context):
        ...
        # Header row: context selector + refresh
